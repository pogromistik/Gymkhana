...
class m170310_041558_add_columns_to_Championships extends Migration
{
    public function safeUp()
    {
	    ...
	    $this->addColumn(\common\models\Championship::tableName(), 'amountInOtherRegions', $this->integer()->notNull()->defaultValue(0));
    ...
    public function safeDown()
    {
	    ...
	    $this->dropColumn(\common\models\Championship::tableName(), 'amountInOtherRegions');
