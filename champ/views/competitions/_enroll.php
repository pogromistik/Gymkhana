    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="help-for-athlete">
                <small>
					<?= \yii\bootstrap\Html::a(\Yii::t('app', 'Если Вы зарегистрированы у нас на сайте - пожалуйста, сперва ВОЙДИТЕ В ЛИЧНЫЙ КАБИНЕТ'), ['/site/login']) ?>
                </small>
            </div>
            ...
            <div class="registration-city">
                ...
                <div id="city-text" class="inactive">
					<?= $form->field($participant, 'city')->textInput(['placeholder' => \Yii::t('app', \Yii::t('app', 'Введите Ваш город и регион')), 'id' => 'city-text-input']) ?>
                </div>
            </div>
