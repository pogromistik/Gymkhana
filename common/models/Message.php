...
class Message extends \yii\db\ActiveRecord
{
	...
	public function attributeLabels()
	{
		return [
			...
			'userId'     => \Yii::t('app', 'Отправитель'),
			'dateAdded'  => \Yii::t('app', 'Дата'),
			'athleteIds' => \Yii::t('app', 'Спортсмены, которым будет отправлено письмо'),
			'stageId'    => \Yii::t('app', 'Этап, всем участникам которого будет отправлено письмо')
		];
	}
