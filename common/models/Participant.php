...
class Participant extends BaseActiveRecord
{
	...
	public function attributeLabels()
	{
		return [
			...
			'place'               => \Yii::t('app', 'Место в соревнованиях'),
			'placeOfClass'        => \Yii::t('app', 'Место в классе награждения'),
			'placeOfAthleteClass' => \Yii::t('app', 'Место в классе спортсмена'),
			'number'              => \Yii::t('app', 'Номер спортсмена'),
			'sort'                => \Yii::t('app', 'Порядок выступления'),
			'dateAdded'           => \Yii::t('app', 'Дата добавления'),
			'status'              => \Yii::t('app', 'Статус'),
			'percent'             => \Yii::t('app', 'Рейтинг'),
			'newAthleteClassId'   => \Yii::t('app', 'Класс по итогам проведенного этапа'),
			'points'              => \Yii::t('app', 'Баллы за этап'),
			'pointsByMoscow'      => \Yii::t('app', 'Баллы за этап по Московской схеме'),
			'isArrived'           => \Yii::t('app', 'Участник приехал на этап')
		];
	}
	...
	public function beforeValidate()
	{
		if ($this->isNewRecord) {
			...
			//Если человек участвовал в предыдущих этапах - переносим его номер
