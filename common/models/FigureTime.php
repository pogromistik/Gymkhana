...
class FigureTime extends BaseActiveRecord
{
	...
	public function attributeLabels()
	{
		return [
			...
			'yearId'                => \Yii::t('app', 'Год'),
			'athleteClassId'        => \Yii::t('app', 'Класс спортсмена'),
			'newAthleteClassId'     => \Yii::t('app', 'Новый класс'),
			...
			'resultTimeForHuman'    => \Yii::t('app', 'Итоговое время'),
			'recordInMoment'        => \Yii::t('app', 'Эталонное время на тот момент'),
			'videoLink'             => \Yii::t('app', 'Видео'),
			'actualPercent'         => \Yii::t('app', 'Актуальный рейтинг')
		];
	}
