...
class Stage extends BaseActiveRecord
{
	...
	public function attributeLabels()
	{
		return [
			...
			'cityId'                 => \Yii::t('app', 'Город проведения'),
			'description'            => \Yii::t('app', 'Описание'),
			'dateAdded'              => \Yii::t('app', 'Дата создания'),
			'dateUpdated'            => \Yii::t('app', 'Дата редактирования'),
			'dateOfThe'              => \Yii::t('app', 'Дата проведения'),
			'dateOfTheHuman'         => \Yii::t('app', 'Дата проведения'),
			'startRegistration'      => \Yii::t('app', 'Начало регистрации'),
			'startRegistrationHuman' => \Yii::t('app', 'Начало регистрации'),
			'endRegistration'        => \Yii::t('app', 'Завершение регистрации'),
			'endRegistrationHuman'   => \Yii::t('app', 'Завершение регистрации'),
			'status'                 => \Yii::t('app', 'Статус'),
			'class'                  => \Yii::t('app', 'Класс соревнования'),
			'countRace'              => \Yii::t('app', 'Количество заездов'),
			'referenceTime'          => \Yii::t('app', 'Эталонное время'),
			'referenceTimeHuman'     => \Yii::t('app', 'Эталонное время'),
			'trackPhoto'             => \Yii::t('app', 'Фото трассы'),
			'photoFile'              => \Yii::t('app', 'Фото трассы'),
			'trackPhotoStatus'       => \Yii::t('app', 'Опубликовать трассу'),
			'countryId'              => \Yii::t('app', 'Страна'),
			'documentId'             => \Yii::t('app', 'Регламент'),
			'participantsLimit'      => \Yii::t('app', 'Допустимое количество участников'),
			'fastenClassFor'         => \Yii::t('app', 'Закрепить класс участников за ... дней до этапа')
		];
	}
