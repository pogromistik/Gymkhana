...
class Championship extends BaseActiveRecord
{
	...
	public function attributeLabels()
	{
		return [
			...
			'yearId'               => \Yii::t('app', 'Год проведения'),
			'status'               => \Yii::t('app', 'Статус'),
			'groupId'              => \Yii::t('app', 'Раздел'),
			'regionGroupId'        => \Yii::t('app', 'Региональный раздел'),
			'dateAdded'            => \Yii::t('app', 'Дата создания'),
			'dateUpdated'          => \Yii::t('app', 'Дата редактирования'),
			'regionId'             => \Yii::t('app', 'Регион проведения чемпионата'),
			'minNumber'            => \Yii::t('app', 'Минимальный номер участника'),
			'maxNumber'            => \Yii::t('app', 'Максимальный номер участника'),
			'amountForAthlete'     => \Yii::t('app', 'Обязательное количество этапов для спортсмена'),
			'requiredOtherRegions' => \Yii::t('app', 'Необходимо хоть раз выступить в другом городе'),
			'estimatedAmount'      => \Yii::t('app', 'Количество этапов, по которым подсчитывается итог'),
			'isClosed'             => \Yii::t('app', 'Закрытый чемпионат'),
			'onlyRegions'          => \Yii::t('app', 'Регионы, которые могут принимать участие'),
			'useCheScheme'         => \Yii::t('app', 'Использовать Челябинскую схему для награждения'),
			'showResults'          => \Yii::t('app', 'Показывать итоги чемпионата'),
			'useMoscowPoints'      => \Yii::t('app', 'Считать баллы по Московской схеме')
		];
	}
