...
?>
    <b>
		<?= \Yii::t('app', 'Анонсирован новый этап чемпионата {champTitle}: "{stageTitle}"!', [
			'champTitle' => '<a href="http://gymkhana-cup.ru/competitions/special-champ?id=' . $championship->id . '" target="_blank" style="color: #56a025">'.$championship->getTitle($language).'</a>',
