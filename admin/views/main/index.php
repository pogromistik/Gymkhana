...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="alert alert-info">
            Рекомендуемые пропорции изображения 16:9. В любом случае, все изображения должны быть одинаковых пропорций.<br>
            Максимальное число загружаемых файлов: 10
        </div>
		<?= FileInput::widget([
			'name'          => 'attachment_48[]',
			'options'       => [
    ...
    <div class="col-xs-12">
        <h3>2. Левое меню</h3>
        <div class="alert alert-info">
            Рекомендуемые пропорции изображения 3:2.<br>
            Максимальное число загружаемых файлов: 10
        </div>
		<?= FileInput::widget([
			'name'          => 'attachment_48[]',
