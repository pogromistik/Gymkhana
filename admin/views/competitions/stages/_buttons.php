...
<div class="alert help-alert alert-info">
    ...
    <ol>
		...
		<?php } ?>
        <li>
            На странице "Итоги" выводится итоговая таблица с результатами этого этапа. Там же можно добавить видео
            заездов.
        </li>
        <li>
...
<?php if (\Yii::$app->user->can('projectAdmin')) { ?>
    <div class="pt-10">
        <a href="#" class="ajaxDelete btn btn-my-style btn-red small" data-id="<?= $model->id ?>"
           data-action="stage">Удалить этап</a>
    </div>
<?php } ?>
