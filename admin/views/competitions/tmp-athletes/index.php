...
<div class="alert help-alert alert-info">
    ...
    <ul>
        ...
        <li>
            ...
            здорово, если на всякий случай вы предварительно посмотрите список всех спортсменов с такой фамилией).<br>
            ...
            <ol>
                ...
                <li>
                    Если есть верное совпадение - создайте кабинет спортсмену. Мы нажимать эту кнопку, даже если кабинет
