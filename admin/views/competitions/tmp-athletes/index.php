    ...
    <ul>
        ...
        <li>
            ...
            <ol>
                ...
                <li>
                    Если есть верное совпадение - создайте кабинет спортсмену. Мы рекомендуем нажимать эту кнопку, даже если кабинет
                    уже был создан - в таком случае, человеку просто будет отправлен новый пароль.
                </li>
                <li>
                    Если вы создаёте кабинет существующему спортсмену, у которого в системе ещё нет мотоцикла, указанного в заявке,
                    то после нажатия на кнопку "создать кабинет этому спортсмену" вам будет предложено выбрать мотоциклы для добавления.
                    Если же все мотоциклы уже есть в системе, но окно всё равно появилось - просто нажмите кнопку "Добавить", не
        ...
        <li>
            ...
            спортсмена. Если его нет - создайте город на странице "<?= Html::a('Города', ['/competitions/help/cities']) ?>"
        </li>
    </ul>
</div>
			...
			[
				...
				'value'  => function (\common\models\TmpAthlete $athlete) {
					...
					foreach ($motorcycles as $motorcycle) {
						$motorcyclesTitle .= '<li>' . $motorcycle['mark'] . ' ' . $motorcycle['model'] . '</li>';
					}
					$motorcyclesTitle .= '</ul>';
