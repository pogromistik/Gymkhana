...
?>
    ...
    <div class="alert help-alert alert-info">
        ...
        <ul>
            <li>
                Спортсмены отображаются в порядке, указанном на странице
				<?= Html::a('со списком участников', ['/competitions/participants/index', ['stageId' => $stage->id]]) ?>
            </li>
            <li>
                Формат времени: минуты:секунды.миллисекунды. Необходимо обязательно указывать все 6 цифр.
            </li>
            <li>
                В случае незачета всё равно укажите время, за которое человек проехал трассу. Если времени нет -
                оставьте поле пустым или введите время не меньше, чем 59:59.99.
            </li>
            <li>
                Если штрафа нет - введите 0 или оставьте поле пустым.
            </li>
            <li>
                Сохранение результата - по нажатию на кнопку или по нажатию на enter. При сохранении результата курсор
                автоматически устанавливается в следующую строчку.
            </li>
            <li>
                При сохранении соответствующая строчка будет обведена в зелёную рамку. Если этого не произошло -
                сохраните ещё раз, или обновите страницу и убедитесь, что результат добавлен.
            </li>
            <li>
                Старайтесь не пользоваться кнопкой "сохранить всё" - она нужна только на случай, если вы ввели много
                результатов, забывая их сохранять. Будьте осторожны - если вы не сохраняете каждый результат,
                рассчитывае потом нажать эту кнопку, могут получиться неприятные ситуации. Например, если в этот момент
                у вас пропадёт интернет, есть шанс потерять эти результаты.
            </li>
            <li>
                Если вы сохраняли каждый результат, нажатие кнопки "сохранить всё" не требуется.
            </li>
            <li>
                Мы рекомендуем дублировать все результаты где-то ещё - бумага, доска, электронное табло и т.д.
            </li>
        </ul>
    </div>
